...
\begin{ressection}{Technical Summary}
	...
	\resitem{\textbf{Systems/Tools:} Linux and Unix variants (Debian, Ubuntu, Solaris), OSX, Windows 2000/XP/Vista/7, SVN, Git, Mercurial, Eclipse, Trixbox (Asterisk based PBX), Apache, VMWare ESX, Multithreaded Environments (Using Agents), Maven }
